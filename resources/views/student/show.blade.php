                ...
                <div class="w-full lg:w-[50%] px-8">
                    <div class="w-full">
                        <img class="rounded-md shadow-lg object-cover"
                            src="https://media.istockphoto.com/photos/african-student-sitting-in-classroom-picture-id1351445530?b=1&k=20&m=1351445530&s=170667a&w=0&h=9Lmy0oy3tqoFgvuIPhEKPhbNQrLR12Ym518Zjs-KpF4="
                            alt="">
                    </div>
                </div>
                ...
                <tbody>
                    <tr>
                        ...
                        <td class="py-2 bg-slate-100 text-center px-3">
                            {{$student->classrooms->sortByDesc('classrooms.created_at')->first()->name}}</td>
