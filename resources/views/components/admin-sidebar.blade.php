...
<div id="main-nav" class="pt-20 z-40 hidden w-[50%] top-0 left-0 md:flex md:w-[20%] fixed h-[100vh] bg-slate-100">
    <div class="flex flex-col mt-16 items-center w-full text-sm my-8">
        <ul class="text-blue-strath space-y-4">
            @if($focus == 'student')
            <div
                class="bg-[#00447D] text-white flex flex-row h-16 items-center space-x-4 text-sm mx-4 lg:text-base rounded drop-shadow">
                <i class="fa-solid fa-user-graduate ml-4"></i>
                <li class="pr-4"><a href="{{route('admin')}}">Student Management</a></li>
            </div>
            @else
            <div
                class="hover:text-[#A11111] flex flex-row h-16 items-center space-x-4 text-sm mx-4 lg:text-base  rounded drop-shadow">
                <i class="fa-solid fa-user-graduate ml-4"></i>
                <li class="pr-4"><a href="{{route('admin')}}">Student Management</a></li>
            </div>
            @endif
            ...
            <div
                ...
                <li class="pr-4"><a href="{{route('admin.behavioursheet')}}">Discipline Management</a></li>
            </div>
            @else
            <div
                class="hover:text-[#A11111] flex flex-row h-16 items-center space-x-4 text-sm mx-4 lg:text-base  rounded drop-shadow">
            ...
            <div
                ...
                <li class="pr-4"><a href="{{route('admin.homework.homework')}}">Homework Management</a></li>
            </div>
            @else
            <div
                class="hover:text-[#A11111] flex flex-row h-16 items-center space-x-4 text-sm mx-4 lg:text-base rounded drop-shadow">
