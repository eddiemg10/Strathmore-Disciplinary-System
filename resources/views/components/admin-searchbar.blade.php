<div class="font-['Nunito'] w-1/3 container bg-white drop-shadow-md flex flex-col p-8">
    ...
    <div class="w-full my-4 flex justify-center border border-[#000000] rounded">
        <select name="classroom_id" id="classroom_id" class="w-full text-gray text-xs p-4 border rounded form-control">
            <option value="option_select" disabled selected><span class="text-gray">All Classrooms</span></option>
    ...
    <div class="w-full my-4 py-2 flex justify-center border border-black rounded pr-4">
        <input type="text" name="search" id="search" class="border border-0 m-0 w-full text-xs form-control" placeholder="Search by one name">     
    ...
    <div class="my-4 py-1 flex justify-center">
        <table class="table table-striped table-hover w-full rounded">
