<x-edit-parent id="update-parent" type="update" title="Parent Information" :parent="$parent" />
    ...
    <div class="flex flex-col items-center">
        ...
        <div class="mt-20 flex flex-col lg:flex-row gap-y-5 lg:items-center">
            ...
            <div class="w-full lg:w-[50%] px-5 flex flex-col gap-y-5 items-center">
                ...
                <form method="POST" action="{{ route('user.delete') }}" class="w-full" id="delete-form">
                    @csrf
...
$("#edit-parent").click(function(e){
    ...
    $("#update-parent").addClass('flex');
})

$(".close-modal").click(function(e){
    $("#update-parent").removeClass('flex');
    $("#update-parent").addClass('hidden');
});
